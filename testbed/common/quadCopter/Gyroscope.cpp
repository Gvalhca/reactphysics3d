...
rp3d::Vector3 drone::Gyroscope::toEulerAngles(const rp3d::Quaternion& q) const {
    rp3d::Vector3 angles;
...
rp3d::Vector3 drone::Gyroscope::getPRYFromQuaternion(const rp3d::Quaternion& Q) const {
    double toDegrees = 180 / M_PI;
